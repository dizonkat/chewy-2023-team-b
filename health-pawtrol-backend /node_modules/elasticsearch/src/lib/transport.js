...
var errors = require('elasticsearch/src/lib/errors');
var Host = require('elasticsearch/src/lib/host');
var patchSniffOnConnectionFault = require('elasticsearch/src/lib/transport/sniff_on_connection_fault');
var findCommonProtocol = require('elasticsearch/src/lib/transport/find_common_protocol');
...
function Transport(config) {
  ...
  var LogClass =
    typeof config.log === 'function' ? config.log : require('elasticsearch/src/lib/log');
...
Transport.connectionPools = {
  main: require('elasticsearch/src/lib/connection_pool'),
};

Transport.serializers = require('elasticsearch/src/lib/serializers');

Transport.nodesToHostCallbacks = {
  main: require('elasticsearch/src/lib/nodes_to_host'),
};
